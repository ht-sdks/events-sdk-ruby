...
module Hightouch
  class Analytics
    describe Analytics do
      let(:analytics) { Hightouch::Analytics.new :write_key => WRITE_KEY, :stub => true }
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of Hightouch::Analytics::Client' do
          expect(analytics).to respond_to(*Hightouch::Analytics::Client.public_instance_methods(false))
        end
      end

      describe '#method' do
        Hightouch::Analytics::Client.public_instance_methods(false).each do |public_method|
      ...
      describe '#test_queue' do
        context 'when not in mode' do
          let(:analytics) { Hightouch::Analytics.new :write_key => WRITE_KEY, :stub => true, :test => true }
        ...
        context 'when not in test mode' do
          let(:analytics) { Hightouch::Analytics.new :write_key => WRITE_KEY, :stub => true, :test => false }
